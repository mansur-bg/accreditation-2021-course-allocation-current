...
<head>
    ...
    <title>Department of Computer Science, BUK - Course Allocation Application</title>
    <!-- Fevicon -->
...
{{--                    </div>--}}
        ...
        <div class="footerbar">
            <footer class="footer">
                <p class="mb-0">©
                    <script type="text/javascript">document.write(new Date().getFullYear());</script> Mansur Babagana</p>
            </footer>
        </div>
        <!-- End Footerbar -->
    </div>
